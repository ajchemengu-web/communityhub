...
const libraryBooks = [
  ...
  LibraryBookMeta(
    ...
    subtitle: 'Book 1 · Microeconomics',
    author: 'Anonymous',
    emoji: '📈',
    heroIcon: Icons.show_chart_rounded,
    pattern: BookCoverPattern.circuit,
    bgColor: Color(0xFF001A16),
    accentColor: Color(0xFF26A69A),
    stats: '16 Chapters • 4 Parts • Exam Revision Guide',
    storageFile: 'ku-econ-microeconomics.json',
  ),
  LibraryBookMeta(
    id: 'ku-macro',
    title: 'KU Economics Revision Series',
  ...
  LibraryBookMeta(
    id: 'ku-stats',
    title: 'KU Economics Revision Series',
    subtitle: 'Book 4 · Statistics & Econometrics',
    author: 'Anonymous',
    emoji: '🔢',
    heroIcon: Icons.query_stats_rounded,
    pattern: BookCoverPattern.circuit,
    bgColor: Color(0xFF0A0C1A),
    accentColor: Color(0xFF5C6BC0),
    stats: '16 Chapters • 4 Parts • Exam Revision Guide',
    storageFile: 'ku-econ-statistics-econometrics.json',
  ),
];
